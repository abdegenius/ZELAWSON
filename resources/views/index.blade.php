...
<body>
    <div class="wrapper">
        ...
        <div id="page" class="stylehome1 h0">
            <div class="mobile-menu">
                <div class="header stylehome1">
                    <div class="main_logo_home2 text-center"> <img class="nav_logo_img img-fluid mt10" src="images/header-logo.svg" alt="header-logo.svg"> <span class="mt15">Zelawson Homes</span> </div>
            ...
            <nav id="menu" class="stylehome1">
                <ul>
                    ...
                    <li><a href="page-contact.html">Contact</a></li>
                    <li class="cl_btn"><a class="btn btn-block btn-lg btn-thm rounded" href="#"><span class="icon flaticon-button mr5"></span> Sign Up</a></li>
                </ul>
            </nav>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4">
                        <div class="copyright-widget mt10 mb15-767">
                            <p>Copyright © 2021 Zelawson Homes. All Right Reserved.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4">
                        <div class="footer_logo_widget text-center mb15-767">
                            <div class="wrapper">
                                <div class="logo text-center"> <img src="{{ asset('images/footer-logo.svg') }}" alt="footer-logo.svg"> <span class="logo_title text-white pl15">Zelawson Homes</span> </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4">
        ...
        <a class="scrollToHome home3" href="#"><i class="fa fa-angle-up"></i></a>
    </div>
    <!-- Wrapper End -->
